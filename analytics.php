...
Analytics\Config::set('pi_version', '0.0.1');
Analytics\Config::set('gl_version', '2.0.0');

$_AN_table_prefix = $_DB_table_prefix . 'ua_';

$_TABLES['ua_trackers'] = $_AN_table_prefix . 'trackers';
$_TABLES['ua_sess_info'] = $_AN_table_prefix . 'sess_info';
