...
if (!SEC_inGroup('Root')) {
    ...
    COM_errorLog("Someone has tried to access the Analytics Development Code Upgrade Routine without proper permissions.  User id: {$_USER['uid']}, Username: {$_USER['username']}, IP: " . $_SERVER['REMOTE_ADDR'],1);
    COM_404();
    exit;
}
