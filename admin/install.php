<?php
/**
 * Installation functions for the Analytics plugin.
 *
...
require_once $_CONF['path'].'/plugins/analytics/autoinstall.php';
...
if (!SEC_inGroup('Root')) {
    ...
    Log::write('system', Log::ERROR, "Someone has tried to illegally access the Analytics install/uninstall page.  User id: {$_USER['uid']}, Username: {$_USER['username']}, IP: {$_SERVER['REMOTE_ADDR']}");
...
if (SEC_checkToken()) {
    ...
    if ($action == 'install') {
    	...
    	if (plugin_uninstall_analytics('installed')) {
