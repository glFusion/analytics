...
if (!SEC_inGroup('Root')) {
    ...
    COM_errorLog("Someone has tried to illegally access the Analytics install/uninstall page.  User id: {$_USER['uid']}, Username: {$_USER['username']}, IP: {$_SERVER['REMOTE_ADDR']}",1);
